...
const Navbar = () => {
  ...
  return (
    <nav className="container flex flex-row justify-between items-center p-7 mx-auto sticky z-10 top-0 bg-white dark:bg-gray-900 border-b dark:border-gray-700 transition-colors duration-300">
